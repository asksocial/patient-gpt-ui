...
assert(shell.includes('data-testid="active-module-indicator"') && shell.includes('aria-label={`Current module: ${activeModule.name}`}') && shell.includes("Module: {activeModule.name}"), "The selected module must remain visible beside the workspace control.");
