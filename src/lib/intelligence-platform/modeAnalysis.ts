...
export const MODE_ANALYSIS_PROFILES: ModeAnalysisProfile[] = [
  ...
  },
  {
    ...
    analysisInstructions: [
      ...
      "Extract product or procedure, adverse event, seriousness criteria, outcome, time to onset, severity, expectedness evidence, and reporter causality language as reviewable proposals.",
      "Do not present case validity, seriousness, expectedness, or causality proposals as final regulatory or clinical determinations.",
    ...
    taxonomy: [
      ...
      concept("seriousness", "Seriousness criteria", "adverse_event_ontology", ["hospitalized", "life-threatening", "disability", "death", "birth defect"]),
      concept("outcome", "Reported outcome", "adverse_event_ontology", ["recovered", "ongoing", "hospitalization", "permanent injury"]),
      concept("onset", "Time to onset", "adverse_event_ontology", ["immediately", "hours later", "days later", "weeks later", "months later"]),
      concept("severity", "Reported severity", "adverse_event_ontology", ["mild", "moderate", "severe"]),
      concept("unexpectedness", "Expectedness evidence", "adverse_event_ontology", ["listed", "known side effect", "unexpected", "not listed"]),
      concept("causality_language", "Reporter causality language", "adverse_event_ontology", ["after", "following", "possibly due to", "think it was from"]),
    ...
    outputContract: {
      ...
      requiredSections: [
        ...
        section("adverse_event_ontology", "Adverse-event ontology", "Proposed product or procedure, event, seriousness criteria, outcome, onset, severity, expectedness evidence, and reporter causality language."),
        section("workflow_routing", "Required workflow routing", "Human review, timing, transfer, and audit requirements."),
      ],
      requiredFields: ["summary", "evidenceFindingIds", "productProcedure", "adverseEvent", "seriousness", "outcome", "timeToOnset", "severity", "unexpectedness", "causalityLanguage", "limitations"],
    },
    toolRouting: {
